...
-
Nous offrons la possibilité de trouver un ou plusieurs taxis disponibles pour une date donnée en échange de quoi l'autre groupe pourra trouver les visites disponibles pour différentes conditions. Nous avons ouvert le port mysql, sur la machine hôte, pour tout le monde sinon la connection était refusé.
Ainsi nous ne pouvions pas accéder à leur base de données (ils n'avaient pas ouvert ce port) mais l'autre groupe a pu utilisé nos fonctions sans problème.
